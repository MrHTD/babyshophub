...
class ProductCategories extends StatefulWidget {
  ...
  ProductCategories({Key? key, required this.categoryModel}) : super(key: key);

  @override
  State<ProductCategories> createState() => ProductCategoriesState();
}
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Text(
                  "Showing Products of: ${widget.categoryModel.categoryName}",
              ...
              StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    .collection('Products')
                    .where('category',
                        isEqualTo: widget.categoryModel.categoryName)
                    .snapshots(),
